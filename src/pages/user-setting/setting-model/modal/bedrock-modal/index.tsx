    ...
    >
      <Form {...form}>
        ...
        >
          ...
          <IntellectFormItem name="model_type" label={t('modelType')} required>
            {(field) => (
              <MultiSelect
          ...
          <IntellectFormItem name="llm_name" label={t('modelName')} required>
          ...
          {!instanceExists && (
            <>
              <div className="mb-4">
                <IntellectFormItem name="auth_mode">
                  {(field) => (
                    <Segmented
                      value={field.value}
                      onChange={(value) => {
          ...
          <IntellectFormItem name="max_tokens" label={t('maxTokens')} required>
            {(field) => (
              <Input
                type="number"
