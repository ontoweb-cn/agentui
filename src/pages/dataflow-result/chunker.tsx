...
import {
  IntellectPagination,
  IntellectPaginationType,
} from '@/components/ui/intellect-pagination';
...
const ChunkerContainer = (props: IProps) => {
  ...
  const onPaginationChange: IntellectPaginationType['onChange'] = (
    page,
    size,
  ) => {
    setSelectedChunkIds([]);
        ...
        <Spin spinning={loading} className={styles.spin} size="large">
          <div className="h-[50px] flex flex-row justify-between items-end pb-[5px]">
            ...
            <ChunkResultBar
              ...
              createChunk={
                showChunkUpdatingModal as unknown as (text: string) => void
              }
              isReadonly={false}
            />
          </div>
              ...
              >
                {chunkList.map((item) => (
                  <ChunkCard
                    ...
                    clickChunkCard={
                      handleChunkCardClick as unknown as (
                        chunkId: string,
                      ) => void
                    }
