...
import { IntellectLogo } from './intellect-logo';
                    ...
                    return (
                      <div key={index}>
                        <div className="w-full flex flex-col">
                          ...
                          {(chunk as any).document_metadata &&
                            Object.keys((chunk as any).document_metadata).length > 0 && (
                              <div className="flex flex-wrap gap-2 mt-2">
                                {Object.entries((chunk as any).document_metadata).map(
                                  ([key, value]) => (
                                    <div
                                      key={key}
