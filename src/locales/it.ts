...
Esempio: un messaggio di 1 KB con embedding a 1024 dimensioni usa ~9 KB. Il limite predefinito di 5 MB contiene ~500 messaggi di questo tipo.`,
    ...
    knowledgeDetails: {
      ...
      retrievalTestingDescription:
        'Esegui un test di recupero per verificare se Intellect riesce a recuperare il contenuto previsto per il LLM.',
      Parse: 'Analizza',
      dataset: 'Dataset',
      ...
      uploadDescription:
        "Supporta caricamento singolo o multiplo. Per un Intellect distribuito localmente: il limite di dimensione totale dei file per caricamento è 1GB, con un limite batch di 32 file. Non c'è limite al numero totale di file per account. Per cloud.intellect.ontoweb.cn, il limite di dimensione totale dei file per caricamento è 10MB, con ogni file non superiore a 10MB e un massimo di 128 file per account.",
      chunk: 'Chunk',
      bulk: 'Multiplo',
      cancel: 'Annulla',
      close: 'Chiudi',
      ...
      rerankTip: `Opzionale. Se lasciato vuoto, Intellect userà una combinazione di similarità delle parole chiave ponderata e similarità coseno vettoriale ponderata; se viene selezionato un modello rerank, un punteggio di reranking ponderato sostituirà la similarità coseno vettoriale ponderata. Tieni presente che l'uso di un modello rerank aumenterà significativamente il tempo di risposta del sistema. Se desideri usare un modello rerank, assicurati di usare un reranker SaaS; se preferisci un modello rerank distribuito localmente, assicurati di avviare Intellect con docker-compose-gpu.yml.`,
      topK: 'Top-K',
...
`,
    ...
    knowledgeConfiguration: {
      ...
      tableColumnModeAutoDescription:
        'Tutte le colonne sono incluse nel testo del chunk e memorizzate come metadati (predefinito Intellect).',
...
`,
      useRaptor: 'RAPTOR',
      useRaptorTip:
        'RAPTOR può essere usato per attività di question-answering multi-hop. Naviga alla pagina File, clicca Genera > RAPTOR per abilitarlo. Vedi https://intellect.ontoweb.cn/docs/dev/enable_raptor per i dettagli.',
      prompt: 'Prompt',
      promptTip:
...
Quanto sopra è il contenuto che devi riassumere.`,
      ...
      tagSet: 'Set di tag',
      tagSetTip: `
     <p> Seleziona uno o più dataset tag per auto-taggare i chunk nel tuo dataset. Vedi https://intellect.ontoweb.cn/docs/dev/use_tag_sets per i dettagli.</p>
...
<ul>
  ...
  <li>La funzionalità auto-keyword dipende dall'LLM e consuma un numero significativo di token.</li>
      ...
      useGraphRagTip:
        'Costruisci un grafo della conoscenza sui chunk di file del dataset corrente per migliorare il question-answering multi-hop che coinvolge logica annidata. Vedi https://intellect.ontoweb.cn/docs/dev/construct_knowledge_graph per i dettagli.',
...
**Regole essenziali:**
  ...
  - **Considera sempre** l'intera cronologia della conversazione.`,
      ...
      **Regole essenziali:**
      ...
      betaError:
        'Per favore acquisisci prima una chiave API Intellect dalla pagina Impostazioni di sistema.',
...
Esempio: Virtual Hosted Style`,
      ...
      embeddingModelTip:
        'Il modello di embedding predefinito per ogni nuovo dataset creato. Se non riesci a trovare un modello di embedding dal menu a discesa, controlla se stai usando la versione slim di Intellect (che non include modelli di embedding) o controlla https://intellect.ontoweb.cn/docs/dev/supported_models per vedere se il tuo fornitore di modelli supporta questo modello.',
      img2txtModel: 'VLM',
      img2txtModelTip:
        "Il VLM predefinito per ogni nuovo dataset creato. Descrive un'immagine o un video. Se non riesci a trovare un modello dal menu a discesa, controlla https://intellect.ontoweb.cn/docs/dev/supported_models per vedere se il tuo fornitore di modelli supporta questo modello.",
      ...
      rerankModel: 'Rerank',
      rerankModelTip: `Il modello rerank predefinito per il reranking dei chunk. Se non riesci a trovare un modello dal menu a discesa, controlla https://intellect.ontoweb.cn/docs/dev/supported_models per vedere se il tuo fornitore di modelli supporta questo modello.`,
      ttsModel: 'TTS',
      ttsModelTip:
        'Il modello text-to-speech predefinito. Se non riesci a trovare un modello dal menu a discesa, controlla https://intellect.ontoweb.cn/docs/dev/supported_models per vedere se il tuo fornitore di modelli supporta questo modello.',
      workspace: 'workspace',
      upgrade: 'Aggiorna',
