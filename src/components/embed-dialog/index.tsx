      ...
      <DialogContent className="sm:max-w-4xl">
        ...
        <section className="w-full overflow-auto space-y-5 text-sm text-text-secondary">
            ...
            <form className="space-y-5">
              <Tabs defaultValue="embed" className="w-full">
                ...
                <TabsContent value="embed" className="space-y-5">
                  ...
                  <IntellectFormItem name="locale" label={t('chat.locale')}>
                    <SelectWithSearch
                      options={languageOptions}
                    ></SelectWithSearch>
                  </IntellectFormItem>
                  {isAgent && (
                    <IntellectFormItem name="userId" label={t('flow.userId')}>
                      <Input></Input>
                    </IntellectFormItem>
                  )}
                </TabsContent>
                <TabsContent value="widget" className="space-y-5">
                  ...
                  <div className="grid gap-4 md:grid-cols-2">
                    <IntellectFormItem name="widgetTitle" label="Widget title">
                      <Input placeholder="Chat Support"></Input>
                    </IntellectFormItem>
                    <IntellectFormItem name="widgetSubtitle" label="Subtitle">
                    ...
                    <IntellectFormItem
                      ...
                      label="Footer text"
                    >
                      <Input placeholder="Powered by Intellect"></Input>
                    </IntellectFormItem>
                    <IntellectFormItem
                      name="widgetFooterLink"
                      label="Footer redirect link"
                    >
                      <Input placeholder="https://intellect.ontoweb.cn"></Input>
                    </IntellectFormItem>
                    <FormField
                      control={form.control}
          ...
          <a
            ...
            href={
              isAgent
                ? 'https://intellect.ontoweb.cn/docs/dev/http_api_reference#create-session-with-agent'
                : 'https://intellect.ontoweb.cn/docs/dev/http_api_reference#create-session-with-chat-assistant'
            }
            target="_blank"
            rel="noreferrer"
          >
