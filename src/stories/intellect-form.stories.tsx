...
// Create a wrapper component to demonstrate IntellectFormItem
...
const meta = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: `
## IntellectFormItem Component

IntellectFormItem is a wrapper component built on top of shadcn/ui Form components, providing unified form item styling and layout.
