...
const meta = {
  title: 'Example/IntellectAvatar',
  component: IntellectAvatar,
  parameters: {
    ...
    docs: {
      description: {
        component: `
## IntellectAvatar Component

IntellectAvatar is a customizable avatar component that displays user avatars with intelligent fallbacks. When an image is not available, it generates colorful gradient backgrounds with user initials.
...
} satisfies Meta<typeof IntellectAvatar>;
