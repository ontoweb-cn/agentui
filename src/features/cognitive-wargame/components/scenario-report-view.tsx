/**
 * ScenarioReportView 评估报告（共享视图组件，供导航台 Tab 与独立 ReportViewPage 复用）。
 *
 * 四 Tab：
...
export const ScenarioReportView: React.FC<{ scenarioId: string }> = ({ scenarioId }) => {
...
export default ScenarioReportView;
