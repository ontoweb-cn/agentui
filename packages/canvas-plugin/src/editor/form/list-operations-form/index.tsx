  ...
  return (
    <Form {...form}>
      <FormWrapper>
        ...
        ></QueryVariable>
        <Separator />
        <IntellectFormItem name="operations" label={t('flow.operations')}>
          {(field) => (
            <SelectWithSearch
        ...
        {showSortMethod && (
          <IntellectFormItem name="sort_method" label={t('flow.sortMethod')}>
            <SelectWithSearch options={SortMethodOptions} />
          </IntellectFormItem>
        )}
        {showFilter && (
          <div className="flex items-center gap-2">
            <IntellectFormItem name="filter.operator" className="flex-1">
              <SelectWithSearch options={operatorOptions}></SelectWithSearch>
            </IntellectFormItem>
            <Separator className="w-2" />
            <IntellectFormItem name="filter.value" className="flex-1">
