...
import { IntellectSelect, IntellectSelectOptionType } from '@/components/ui/select';
...
function ParameterForm({
  ...
  const options = useMemo(() => {
    return Object.values(BeginQueryType).reduce<IntellectSelectOptionType[]>(
      (pre, cur) => {
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <IntellectSelect {...field} options={options} />
              </FormControl>
              <FormMessage />
            </FormItem>
          )}
