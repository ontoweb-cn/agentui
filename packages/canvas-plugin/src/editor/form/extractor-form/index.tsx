...
import { PromptEditor } from '@agentui/canvas-plugin/editor/form/components/prompt-editor';
  ...
  return (
    <Form {...form}>
      <FormWrapper>
        ...
        <IntellectFormItem label={t('flow.fieldName')} name="field_name">
          {(field) => (
            <SelectWithSearch
              onChange={(value) => {
        ...
        {!isToc && (
          <IntellectFormItem label={t('flow.systemPrompt')} name="sys_prompt">
            <PromptEditor
